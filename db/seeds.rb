...
ActiveRecord::Base.transaction do
  ...
  CatRentalRequest.new(:cat_id => 1, :start_date => '2014-04-28', :end_date => '2014-05-07').save
  
    CatRentalRequest.new(:cat_id => 1, :start_date => '2014-04-25', :end_date => '2014-04-27' ).save
end